...
#ifndef HANDWRITING_FLAMEWORDS_MODULE_2_FIRERUNESPLITTER_H
#define HANDWRITING_FLAMEWORDS_MODULE_2_FIRERUNESPLITTER_H
...
private:
    ...
    cv::Point2f Top_Middle_First, Top_Middle_Sec, Left_Middle_First, Left_Middle_Sec, Bottom_Middle_First, Bottom_Middle_Sec, Right_Middle_First, Right_Middle_Sec;
};
